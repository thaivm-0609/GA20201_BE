...
//khai bao dich vu xac thuc Authentication
...
}).AddJwtBearer(x =>
{
    ...
    {
        ValidateIssuer = true, //kiem tra ng cung cap token
        ValidateAudience = true, //kiem tra nguoi nhan
        ValidateLifetime = true, //kiem tra thoi gian ton tai
